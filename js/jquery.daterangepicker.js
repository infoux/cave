...
(function(factory) {
  ...
  $.fn.dateRangePicker = function(opt) {
    ...
    if (opt.singleMonth == 'auto') opt.singleMonth = $(window).width() < 1199;
    ...
    function open(animationTime) {
      ...
      box.show();
      $('.date-picker-wrapper').css("height", $(document).height());
      if ($(window).width() < 1199) {
        $('html, body').animate({scrollTop: $(".input-date").offset().top - 60}, 500);
      }
...
*/
    ...
    function generateYearElement(date, month) {
      ...
      if (!opt.yearSelect ||
        ...
        return '<div class="month-element">' + fullYear + '년</div>';
      }
